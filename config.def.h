...
static const char *fonts[]          = { "Source Code Pro:size=11", "monospace:size=11" };
...
static const char selbordercolor[]  = "#32302f";
...
static const char *pbrowser[]  = { "google-chrome-stable", NULL };
